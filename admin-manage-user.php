    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 class="modal-title text-center" style="font-size: 25px; font-weight:600;">Add Employee Info</h2>
        </div>
              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    <label class="control-label text-p-reset" style="margin-bottom: 5px;">Fullname</label>
                    <div class="">
                      <input type="text" placeholder="Enter Employee Name" name="em_fullname" list="expense" class="forminput1" id="default" required>
                    </div>
                  </div>
                   <div class="form-group">
                    <label class="control-label text-p-reset" style="margin-bottom: 5px;">Username</label>
                    <div class="">
                      <input type="text" placeholder="Enter Employee username" name="em_username" class="forminput1" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label text-p-reset" style="margin-bottom: 5px;">Email</label>
                    <div class="">
                      <input type="email" placeholder="Enter Employee Email" name="em_email" class="forminput1" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_employee" class="button-68">Add Employee</button>
                    </div>
                    <div class="col-sm-3">
                      <button type="submit" class="button-38" data-dismiss="modal">Cancel</button>
                    </div>
                  </div>
                </div>
              </form> 
      ...
      <div class="col-md-12">
        ...
        <div class="well well-custom">
          ...
          <?php } ?>
            <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-primary-custom btn-menu" data-toggle="modal" data-target="#myModal" style="margin-bottom: 10px;">Add New Employee</button>
                </div>
              <?php } ?>
